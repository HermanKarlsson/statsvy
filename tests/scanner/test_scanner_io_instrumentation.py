...
class TestScannerIOInstrumentation:
    """I/O instrumentation tests for Scanner internals."""

    def test_file_hash_records_io(self, tmp_path: Path) -> None:
        ...
        scanner = Scanner(
            path=tmp_path, config=Config.default(), perf_tracker=mock_tracker
        )
