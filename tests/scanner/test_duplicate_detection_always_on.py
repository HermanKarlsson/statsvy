...
class TestDuplicateDetectionAlwaysOn:
    """Scanner duplicate-detection behaviour tests."""
    ...
    def test_scanner_detects_duplicates_even_if_config_disabled(
        self, tmp_path: Path
    ) -> None:
        ...
        big_content = "x" * 2048
        self.write_file(a, big_content)
        self.write_file(b, big_content)
